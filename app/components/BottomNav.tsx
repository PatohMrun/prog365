        ...
        {tabs.map(({ id, icon: Icon, label }) => {
          ...
          return (
            ...
            >
              ...
              <div className={`relative transition-transform duration-300 ${isActive ? '-translate-y-2' : ''}`}>
                <Icon
                  size={24}
              ...
              <span className={`text-[10px] font-medium absolute bottom-0.5 transition-all duration-300 ${isActive ? 'opacity-100 translate-y-0 text-[#7dd3fc]' : 'opacity-0 translate-y-2'
                }`}>
                {label}
              </span>
            </button>
